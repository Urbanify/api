...
-- CreateEnum
CREATE TYPE "IssueHistoryAction" AS ENUM ('REPORTED_ISSUE', 'ASSIGNED_AS_FISCAL', 'ASSIGNED_AS_MANAGER', 'MARKED_AS_UNFOUNDED', 'MARKED_AS_VALID', 'ADDED_RESOLUTION', 'MARKED_AS_SOLVED', 'REQUESTED_NEW_SOLUTION');
